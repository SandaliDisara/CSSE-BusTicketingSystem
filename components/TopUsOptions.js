...
import { db, FieldValue } from "./config"; // Import Firestore and FieldValue
...
export default function TopUpOptions() {
  ...
  const handleTopUp = (amount) => {
    ...
    const topUpHistoryRef = creditRef.collection("topUpHistory").doc(); // Creates a new document with an autogenerated ID
    topUpHistoryRef.set({
      amount: amount,
      date: FieldValue.serverTimestamp(), // Use FieldValue.serverTimestamp() to set the current server timestamp
    });
